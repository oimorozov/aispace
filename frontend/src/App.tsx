...
export default function App() {
  ...
  return <div className={`app-shell ${ui.sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
    {!ui.sidebarCollapsed && <aside className="sidebar">
      ...
      <div className="sidebar-section-label">РАБОЧИЕ ПРОСТРАНСТВА</div>
